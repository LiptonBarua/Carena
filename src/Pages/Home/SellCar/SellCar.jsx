        ...
        <div style={{backgroundImage: `url(https://c4.wallpaperflare.com/wallpaper/956/868/1012/car-nissan-race-cars-road-wallpaper-preview.jpg)`, backgroundRepeat: `no-repeat`, backgroundSize: `cover`, backgroundPosition: `center`}}>
          ...
          <div className='flex items-center px-4 md:px-8 pt-10'>
                ...
                <div className='text-white ml-10'>
                    ...
                    <button className="text-[white] border border-[#d01818] hover:bg-[white] hover:border-white hover:text-black active:bg-[#d01818] bg-[#d01818] font-semibold text-sm mt-3 px-6 py-2 outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Search</button>

                </div>
            </div>
          <div className='flex px-4 md:px-8 pt-10 bg-[#d01818]'>
