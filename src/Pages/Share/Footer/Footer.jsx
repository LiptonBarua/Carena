    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          ...
          >
            <div>
              <p className="lg:text-xl font-bold text-white">Services</p>
            ...
            <div>
              <p className="lg:text-xl font-bold text-white">Company</p>
            ...
            <div>
              <p className="lg:text-xl font-bold text-white">Helpful Links</p>
            ...
            <div>
              <p className="lg:text-xl font-bold text-white">Legal</p>
